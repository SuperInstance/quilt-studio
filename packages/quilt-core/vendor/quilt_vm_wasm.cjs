/* @ts-self-types="./quilt_vm_wasm.d.ts" */

class WasmQuiltVM {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmQuiltVMFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmquiltvm_free(ptr, 0);
    }
    /**
     * @param {string} name
     * @param {any} value
    ...
    bind(name, value) {
        ...
        const ret = wasm.wasmquiltvm_bind(this.__wbg_ptr, ptr0, len0, value);
        if (ret[1]) {
     ...
     */
    effect(target, forward, inverse) {
        const ptr0 = passStringToWasm0(target, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(forward, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(inverse, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        wasm.wasmquiltvm_effect(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
    }
    /**
     * @param {string} a
     * @param {string} b
    ...
    link(a, b, relation) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(relation, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        wasm.wasmquiltvm_link(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
    }
    constructor() {
        const ret = wasm.wasmquiltvm_new();
        this.__wbg_ptr = ret;
        WasmQuiltVMFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {string} start
    ...
    reachable(start, relation) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmquiltvm_reachable(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
    /**
     * @returns {any}
     */
    stats() {
        const ret = wasm.wasmquiltvm_stats(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} dt
     */
    tick(dt) {
        wasm.wasmquiltvm_tick(this.__wbg_ptr, dt);
    }
    /**
     ...
     */
    time() {
        const ret = wasm.wasmquiltvm_time(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {string} target
    ...
    view(target, viewer) {
        const ptr0 = passStringToWasm0(target, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(viewer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmquiltvm_view(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
}
if (Symbol.dispose) WasmQuiltVM.prototype[Symbol.dispose] = WasmQuiltVM.prototype.free;
exports.WasmQuiltVM = WasmQuiltVM;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./quilt_vm_wasm_bg.js": import0,
    };
}

const WasmQuiltVMFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmquiltvm_free(ptr, 1));
...
const wasmPath = `${__dirname}/quilt_vm_wasm_bg.wasm`;
